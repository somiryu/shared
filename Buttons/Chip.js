...
function Chip(props){
    ...
    return( 
        <div 
            ...
            style={{cursor:"pointer", display:"flex", alignItems: props.align || "center", justifyContent: props.justify || "center", position:"relative",backgroundImage: props.active ? "url("+props.imageselect+")": "url("+props.imagenoselect+")",...props.style,...props.active===true?props.styleActivate:""}}
        >
            {props.label}
        </div>
    )
