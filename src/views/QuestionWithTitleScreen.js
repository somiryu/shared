...
import CheckboxesWithTitleController from  '../shared/Controllers/CheckboxesWithTitleController'

function QuestionWithTitleScreen(props) {
    ...
    return (
        <Flex align="center" direction="column" style={{marginTop:"10%",marginLeft:"10%",marginRight:"10%"}}>
            ...
            <CheckboxesWithTitleController
                options={[{id:"pregunta1",description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry.",images:{ uncheck: circ20, check: circ40},title:"Titulo1"},
                {id:"pregunta2",description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry.",images:{ uncheck: circ20, check: circ40}},{id:"pregunta3",description:"Lorem Ipsum is simply dummy text of the printing and typesetting industry.",images:{ uncheck: circ20, check: circ40},title:"Titulo1"}]}
            >
            </CheckboxesWithTitleController>
...
export default CheckboxesWithTitleController;