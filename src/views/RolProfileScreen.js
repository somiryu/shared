...
function ProfileScreen(props) {
    return (
        <Flex align="center" direction="column" style={{marginTop:"0%",marginLeft:"10%",marginRight:"10%"}}>
            <Flex align="center" style={{margin:"10px", width:"100%",flexWrap:"wrap"}}>
                <Flex align="center" style={{margin:"0px",maxWidth:"400px"}}>
                    <ImagePanel
                    image={contajuego}
                    padding={"0%"}
                    style={{width:"400px"}}
                ...
                <Flex align="center" style={{margin:"0px",maxWidth:"400px"}} direction={"column"}>
                    <Flex
                        direction="column"
                        align="center"
                    >
                        <MaskedAvatarWithTitle
                            ...
                            debug={true}
                            label={<label style={{color:"#EAAB1C",fontFamily:'Source Serif Pro',fontSize:"14px"}}>SECRETARIA</label>}
                            pointer={true}
